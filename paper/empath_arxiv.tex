...
%% arXiv preprint — submitted to ACM SAC 2027 (BCB Track)
%%
%% Authors: Komala Belur Srinivas, Purna Prasad
%%          Department of Computer Science, Hofstra University
%%
%% SUBMISSION NOTES:
%%   - arXiv version: copyright suppressed, preprint note added
%%   - For ACM double-blind review: \documentclass[sigconf,anonymous]{acmart}
%%     and remove \setcopyright{none} / \acmDOI / \acmISBN lines
%%   - Verify CCS concepts at https://dl.acm.org/ccs
%%   - Page limit: 8 pages + references (SAC BCB track)
%%

\documentclass[sigconf]{acmart}
\setcopyright{none}           %% arXiv: suppress ACM copyright box
...
\usepackage{tcolorbox}      % preprint notice box (arXiv only)
...
%% arXiv preprint notice — remove for camera-ready
\begin{tcolorbox}[colback=gray!10,colframe=gray!50,boxrule=0.4pt,left=4pt,right=4pt,top=2pt,bottom=2pt]
  \small\textit{Preprint. Submitted to the 42nd ACM/SIGAPP Symposium on Applied Computing
  (SAC 2027), BCB Track. This version has not undergone peer review.}
\end{tcolorbox}
\vspace{4pt}
